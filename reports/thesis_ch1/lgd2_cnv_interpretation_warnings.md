# LGD2+ CNV Interpretation Warnings

| scope | warning |
|---|---|
| global | External CNV interpretation output directory not found: analysis/lgd2_interpretation_regeneration_20260707/cnv_feature_importance |
