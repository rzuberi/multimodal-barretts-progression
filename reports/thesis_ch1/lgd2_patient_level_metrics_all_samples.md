...
| 4 | `lgd2_late_fusion_virchow2` | fusion_method=mean | 0.796 | 0.876 | 0.745 | 0.870 | 0.759 | 0.861 | 41 | 13 | 87 | 14 | 0.317 | 0.169 |
| 5 | `lgd2_intermediate_fusion_uni2` | model_name=intermediate_abmil_cnv; cnv_variant=windows_armdiff_plus_arms_plus_cx; cnv_mask_name=none; instance_k=0; subsample_mode=uniform; embed_pca_dim=0 | 0.796 | 0.889 | 0.891 | 0.680 | 0.605 | 0.919 | 49 | 32 | 68 | 6 | 0.653 | 0.163 |
| 6 | `lgd2_coattention_uni2` | model_name=coattn_abmil_cnv; cnv_variant=windows_armdiff_plus_arms_plus_cx; cnv_mask_name=none; instance_k=0; subsample_mode=uniform; embed_pca_dim=0 | 0.791 | 0.889 | 0.873 | 0.710 | 0.623 | 0.910 | 48 | 29 | 71 | 7 | 0.604 | 0.159 |
| 7 | `lgd2_early_fusion_virchow2` | model_name=early_mean_mlp; cnv_variant=windows_armdiff_plus_arms_plus_cx; cnv_mask_name=none; instance_k=0; subsample_mode=uniform; embed_pca_dim=0 | 0.783 | 0.884 | 0.927 | 0.690 | 0.622 | 0.945 | 51 | 31 | 69 | 4 | 0.608 | 0.172 |
| 8 | `lgd2_late_fusion_uni2` | fusion_method=mean | 0.781 | 0.864 | 0.691 | 0.820 | 0.679 | 0.828 | 38 | 18 | 82 | 17 | 0.474 | 0.170 |
| 9 | `lgd2_image_uni2` | model_name=abmil | 0.779 | 0.855 | 0.891 | 0.510 | 0.500 | 0.895 | 49 | 49 | 51 | 6 | 1.000 | 0.206 |
| 10 | `lgd2_late_fusion_virchow2` | fusion_method=stack_logit | 0.772 | 0.846 | 0.491 | 0.930 | 0.794 | 0.769 | 27 | 7 | 93 | 28 | 0.259 | 0.162 |
| 11 | `lgd2_image_virchow2` | model_name=abmil | 0.768 | 0.846 | 0.891 | 0.570 | 0.533 | 0.905 | 49 | 43 | 57 | 6 | 0.878 | 0.203 |
| 12 | `lgd2_early_fusion_virchow2` | model_name=early_mean_mlp_timev1; cnv_variant=windows_armdiff_plus_arms_plus_cx; cnv_mask_name=none; instance_k=0; subsample_mode=uniform; embed_pca_dim=0 | 0.759 | 0.852 | 0.709 | 0.760 | 0.619 | 0.826 | 39 | 24 | 76 | 16 | 0.615 | 0.164 |
| 13 | `lgd2_early_fusion_gigapath` | model_name=early_mean_mlp_timev1; cnv_variant=windows_armdiff_plus_arms_plus_cx; cnv_mask_name=none; instance_k=0; subsample_mode=uniform; embed_pca_dim=0 | 0.757 | 0.829 | 0.709 | 0.780 | 0.639 | 0.830 | 39 | 22 | 78 | 16 | 0.564 | 0.166 |
| 14 | `lgd2_early_fusion_uni2` | model_name=early_mean_mlp_timev1; cnv_variant=windows_armdiff_plus_arms_plus_cx; cnv_mask_name=none; instance_k=0; subsample_mode=uniform; embed_pca_dim=0 | 0.756 | 0.830 | 0.655 | 0.770 | 0.610 | 0.802 | 36 | 23 | 77 | 19 | 0.639 | 0.169 |
| 15 | `lgd2_image_uni2` | model_name=set_transformer_lite | 0.751 | 0.865 | 0.964 | 0.550 | 0.541 | 0.965 | 53 | 45 | 55 | 2 | 0.849 | 0.199 |
| 16 | `lgd2_intermediate_fusion_virchow2` | model_name=intermediate_abmil_cnv; cnv_variant=windows_armdiff_plus_arms_plus_cx; cnv_mask_name=none; instance_k=0; subsample_mode=uniform; embed_pca_dim=0 | 0.748 | 0.858 | 0.891 | 0.670 | 0.598 | 0.918 | 49 | 33 | 67 | 6 | 0.673 | 0.187 |
| 17 | `lgd2_coattention_gigapath` | model_name=coattn_abmil_cnv; cnv_variant=windows_armdiff_plus_arms_plus_cx; cnv_mask_name=none; instance_k=0; subsample_mode=uniform; embed_pca_dim=0 | 0.747 | 0.851 | 0.945 | 0.500 | 0.510 | 0.943 | 52 | 50 | 50 | 3 | 0.962 | 0.214 |
| 18 | `lgd2_image_virchow2` | model_name=set_transformer_lite | 0.747 | 0.848 | 0.855 | 0.660 | 0.580 | 0.892 | 47 | 34 | 66 | 8 | 0.723 | 0.177 |
| 19 | `lgd2_late_fusion_uni2` | fusion_method=stack_logit | 0.741 | 0.827 | 0.436 | 0.940 | 0.800 | 0.752 | 24 | 6 | 94 | 31 | 0.250 | 0.165 |
| 20 | `lgd2_coattention_virchow2` | model_name=coattn_abmil_cnv; cnv_variant=windows_armdiff_plus_arms_plus_cx; cnv_mask_name=none; instance_k=0; subsample_mode=uniform; embed_pca_dim=0 | 0.739 | 0.852 | 0.909 | 0.560 | 0.532 | 0.918 | 50 | 44 | 56 | 5 | 0.880 | 0.200 |
| 21 | `lgd2_image_gigapath` | model_name=set_transformer_lite | 0.729 | 0.829 | 0.891 | 0.590 | 0.544 | 0.908 | 49 | 41 | 59 | 6 | 0.837 | 0.219 |
| 22 | `lgd2_late_fusion_gigapath` | fusion_method=mean | 0.728 | 0.834 | 0.818 | 0.700 | 0.600 | 0.875 | 45 | 30 | 70 | 10 | 0.667 | 0.171 |
| 23 | `lgd2_cnv_core` | model_name=cnv_random_forest; cnv_variant=windows_armdiff_plus_arms_plus_cx; cnv_mask_name=none | 0.660 | 0.777 | 0.345 | 0.960 | 0.826 | 0.727 | 19 | 4 | 96 | 36 | 0.211 | 0.190 |
| 24 | `lgd2_late_fusion_gigapath` | fusion_method=stack_logit | 0.568 | 0.759 | 0.218 | 0.800 | 0.375 | 0.650 | 12 | 20 | 80 | 43 | 1.667 | 0.195 |
...
| `lgd2_late_fusion_virchow2` | fusion_method=mean | 41 | 14 | 13 | 0.317 |
...
| `lgd2_late_fusion_uni2` | fusion_method=mean | 38 | 17 | 18 | 0.474 |
| `lgd2_image_uni2` | model_name=abmil | 49 | 6 | 49 | 1.000 |
| `lgd2_late_fusion_virchow2` | fusion_method=stack_logit | 27 | 28 | 7 | 0.259 |
...
| `lgd2_late_fusion_uni2` | fusion_method=stack_logit | 24 | 31 | 6 | 0.250 |
...
| `lgd2_late_fusion_gigapath` | fusion_method=mean | 45 | 10 | 30 | 0.667 |
...
| `lgd2_late_fusion_gigapath` | fusion_method=stack_logit | 12 | 43 | 20 | 1.667 |
